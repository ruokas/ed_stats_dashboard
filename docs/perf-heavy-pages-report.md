...
Generated: 2026-02-26T15:55:53.242Z
...
- `stage.prepareChartData.cold` (large): median 139.16 ms, p95 145.97 ms, runs=3
- `stage.prepareChartData.filterChange` (large): median 45.75 ms, p95 66.26 ms, runs=3
- `stage.prepareChartData.reset` (large): median 90.29 ms, p95 188.34 ms, runs=3
- `data.computeDailyStats` (large): median 137.39 ms, p95 156.83 ms, runs=3
...
Evidence (large scenario preference):
- `stage.heatmapFilterCache.cold` (large): median 25.44 ms, p95 32.24 ms, runs=3
- `stage.heatmapFilterCache.warm` (large): median 0.02 ms, p95 0.08 ms, runs=3
...
Expected impact: Medium-High | Confidence: High | Score: 53.2
...
Evidence (large scenario preference):
- `stage.hospitalTable.computeStats` (large): median 36.38 ms, p95 45.73 ms, runs=3
- `stage.hospitalTable.departmentTrend` (large): median 5.93 ms, p95 6.61 ms, runs=3
...
Expected impact: Medium | Confidence: High | Score: 48.3
...
Evidence (large scenario preference):
- `stage.totalPath.baseline` (large): median 2286.46 ms, p95 2321.24 ms, runs=3
- `stage.totalPath.sharedComputeContext` (large): median 177.15 ms, p95 189.95 ms, runs=3
- `stage.stats.leaderboard` (large): median 371.33 ms, p95 379.11 ms, runs=3
...
Evidence (large scenario preference):
- `stage.specialtyResolver.init` (large): median 74.82 ms, p95 76.07 ms, runs=3
- `stage.specialty.leaderboard` (large): median 147.85 ms, p95 152.24 ms, runs=3
- `stage.specialty.yearlySmallMultiples` (large): median 70.72 ms, p95 74.19 ms, runs=3
- `stage.specialty.yearlyComposition` (large): median 0.06 ms, p95 0.13 ms, runs=3
...
Evidence (large scenario preference):
- `stage.stats.yearlySmallMultiples` (large): median 78.85 ms, p95 79.06 ms, runs=3
