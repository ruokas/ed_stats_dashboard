...
- 🧠 Pacientų srautų skiltis turi kompaktiškus, vienodai išdėstytus filtrų blokelius („Laikotarpis“, „Metai“, „Rodiklis“, detalizavimo selektoriai ir santrauka su pagalba) – visi valdikliai telpa į vieną tinklelį be horizontalaus slinkimo.
...
4. Išbandykite KPI filtrus: pasirinkite, pvz., 14 d. laikotarpį, „Naktinės“ pamainas ir „Tik GMP“ – kortelės turi persiskaičiuoti, o santrauka viršuje parodyti aktyvius filtrus. Grafikų filtrų forma turi automatiškai perimti tas pačias reikšmes be papildomo derinimo, o pacientų srautų filtrų juosta turi rodyti vienodai išdėstytus kompaktiškus blokelius (laikotarpio mygtukų kapsulę, dviejų išskleidžiamų sąrašų stulpelius, detalizavimo selektorius ir filtrų santrauką su pagalbos mygtuku) be horizontalaus slinkimo. Patikrinkite, kad blokeliai yra tokio pat aukščio, antraštės stovi virš valdiklių, „Laikotarpis“ kapsulė neužima perteklinės vietos, o santrauka su pagalba išlaiko glaudų išdėstymą.
