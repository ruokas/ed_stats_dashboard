...
- 🧠 Pacientų srautų skiltis su dviejų eilučių filtrų juosta: viršuje – trys vienodo pločio „Laikotarpis“, „Metai“ ir „Rodiklis“ grupės, apačioje – filtrų forma su santrauka bei pagalbos mygtuku (be papildomos „Detalizavimas“ antraštės); kiekvienos grupės antraštė iškelta virš valdiklių, kad kompozicija išliktų aiški ir be horizontalaus slinkimo.
...
4. Išbandykite KPI filtrus: pasirinkite, pvz., 14 d. laikotarpį, „Naktinės“ pamainas ir „Tik GMP“ – kortelės turi persiskaičiuoti, o santrauka viršuje parodyti aktyvius filtrus. Grafikų filtrų forma turi automatiškai perimti tas pačias reikšmes be papildomo derinimo, o pacientų srautų filtrų juosta turi išsidėstyti į dvi aiškias eilutes (viršuje „Laikotarpis“, „Metai“, „Rodiklis“, apačioje – filtrų forma su santrauka) be horizontalaus slinkimo. Patikrinkite, kad viršutinės trys grupės yra vienodo pločio ir sulygiuotos, kiekvienos grupės antraštė stovi virš valdiklio, „Laikotarpis“ kapsulė išlieka kompaktiška, o apatinėje eilėje aiškiai matosi filtrų santrauka, pagalbos mygtukas bei detalizavimo selektoriai.
