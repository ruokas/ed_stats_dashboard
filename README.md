...
- 🧠 Pacientų srautų skiltis su sutvarkyta įrankių juosta: kairėje laikotarpio valdikliai, centre filtrų santrauka su pagalbos mygtuku, dešinėje detalizavimo filtrų forma ir trys naratyviniai blokai (kasdienis pulsas, savaitės ritmas, sprendimai).
...
4. Išbandykite KPI filtrus: pasirinkite, pvz., 14 d. laikotarpį, „Naktinės“ pamainas ir „Tik GMP“ – kortelės turi persiskaičiuoti, o santrauka viršuje parodyti aktyvius filtrus. Grafikų filtrų forma turi automatiškai perimti tas pačias reikšmes be papildomo derinimo, o pacientų srautų įrankių juostoje laikotarpio mygtukai, metų selektorius ir rodiklio pasirinkimas turi atnaujinti grafikus bei išsaugoti pasirinktą būseną. Patikrinkite, kad naujoje įrankių juostoje kairysis stulpelis talpina laikotarpio valdiklius, centrinė kortelė rodo filtrų santrauką ir pagalbos mygtuką, o dešinėje esantys detalizavimo filtrai išsidėsto tvarkingame tinklelyje (plačiame ekrane 2–3 stulpeliai, siauresniame – po vieną stulpelį) be netolygaus tarpo.
