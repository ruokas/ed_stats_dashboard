import { createDoctorStatsComputations } from './stats-doctor.js';
...
export const formatLocalDateKey = sharedDateShift.formatLocalDateKey;
...
const doctorStats = createDoctorStatsComputations({
...
export const computeDoctorLeaderboard = (records, options = {}) =>
  doctorStats.computeDoctorLeaderboard(records, options);

export const computeDoctorSpecialtyLeaderboard = (records, options = {}) =>
  doctorStats.computeDoctorSpecialtyLeaderboard(records, options);

export const computeDoctorSpecialtyYearlySmallMultiples = (records, options = {}) =>
  doctorStats.computeDoctorSpecialtyYearlySmallMultiples(records, options);

export const computeDoctorSpecialtyYearlyComposition = (records, options = {}) =>
  doctorStats.computeDoctorSpecialtyYearlyComposition(records, options);

export const computeDoctorYearlyMatrix = (records, options = {}) =>
  doctorStats.computeDoctorYearlyMatrix(records, options);

export const computeDoctorMonthlyTrend = (records, options = {}) =>
  doctorStats.computeDoctorMonthlyTrend(records, options);

export const computeDoctorDayNightMix = (records, options = {}) =>
  doctorStats.computeDoctorDayNightMix(records, options);

export const computeDoctorHospitalizationShare = (records, options = {}) =>
  doctorStats.computeDoctorHospitalizationShare(records, options);
...
export const computeDoctorMoMChanges = (records, options = {}) =>
  doctorStats.computeDoctorMoMChanges(records, options);

export const computeDoctorComparisonPanel = (records, options = {}) =>
  doctorStats.computeDoctorComparisonPanel(records, options);

export const computeDoctorKpiDeltas = (records, options = {}) =>
  doctorStats.computeDoctorKpiDeltas(records, options);
