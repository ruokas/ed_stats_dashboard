...
export function createGydytojaiPageSelectors() {
  ...
  return {
    ...
    gydytojaiFiltersPanel: byId('gydytojaiFiltersPanel'),
    gydytojaiFilterChips: byId('gydytojaiFilterChips'),
    gydytojaiFiltersMainRow: byId('gydytojaiFiltersMainRow'),
    gydytojaiFiltersActionsRow: byId('gydytojaiFiltersActionsRow'),
    ...
    gydytojaiFiltersAdvancedSummary: byId('gydytojaiFiltersAdvancedSummary'),
    ...
    gydytojaiSpecialtyField: byId('gydytojaiSpecialtyField'),
    gydytojaiSpecialtySelect: byId('gydytojaiSpecialtySelect'),
    ...
    gydytojaiActiveFiltersSummary: byId('gydytojaiActiveFiltersSummary'),
    gydytojaiActiveFiltersToggle: byId('gydytojaiActiveFiltersToggle'),
    gydytojaiActiveFiltersPanel: byId('gydytojaiActiveFiltersPanel'),
